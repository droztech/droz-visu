      ...
      <RadixPopover.Portal>
        ...
        >
          ...
          {closeButton &&
            <RadixPopover.Close
            className=
              'flex h-6 w-6 items-center justify-center rounded-full bg-gray-300 text-primary transition-all hover:bg-primary hover:text-gray-100 active:bg-primary-500 active:text-gray-100'
            >
              <X size={16} />
            </RadixPopover.Close>
          }
