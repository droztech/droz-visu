    ...
    <RadixSelect.Root value={value} {...rest}>
      ...
      <RadixSelect.Portal>
        <RadixSelect.Content
          ...
          sideOffset={5}
          collisionPadding={10}
          className="flex flex-col rounded-lg gap-2 border border-gray shadow bg-gray-100 max-w-[calc(100vw-20px)]"
        >
