...
import { Item, AccordionItemProps as ItemProps } from '@radix-ui/react-accordion'
import { FC, Ref, forwardRef, useImperativeHandle, useRef } from 'react'

export interface AccordionItemProps extends ItemProps {}

const AccordionItem: FC<AccordionItemProps> = forwardRef<HTMLDivElement, AccordionItemProps>(
